jQuery(document).ready(function ($) {
    ...
    jQuery('.vaaky-toolbar .vaaky-website-btn').off('click').on('click', function () {
        window.open("https://techunfiltered.dev/?utm_source=plugin&utm_medium=frontend_link&utm_campaign=vaaky_highlighter&utm_id=vaaky_highlighter&utm_term=Website");
    });
